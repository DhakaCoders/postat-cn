...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'postat');
...
if( !function_exists('cbv_theme_setup') ){
    ...
    function cbv_theme_setup(){
      ...
      load_theme_textdomain( 'postat', get_template_directory() . '/languages' );
...
if( function_exists('acf_add_options_page') ) { 
    ...
    acf_add_options_page(array(
        'page_title'    => __('Options', 'postat'),
        'menu_title'    => __('Options', 'postat'),
